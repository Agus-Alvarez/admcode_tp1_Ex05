"""
Pruebe en sus métodos de cálculo que las entradas son de hecho números enteros (con, por ejemplo, isInstance(a, int)), devuelva "ERROR" si el cálculo es imposible, por cierto, maneje explícitamente el caso de la división imposible por cero ( por ejemplo, raise ZeroDivisionError("No se puede dividir por cero") )

Pruebe la eficacia de estas mejoras
"""
...
class SimpleComplexCalculator:
    ...
    def _validar_numeros(self, c1: list, c2: list) -> None:
        ...
        if not all(isinstance(x, (int, float)) for x in c1 + c2):
